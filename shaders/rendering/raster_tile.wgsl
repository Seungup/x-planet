...
// Vertex shader: transforms RTE tile coordinates through per-tile MVP to clip space.
...
struct VertexInput {
    @location(0) position: vec2<f32>,    // RTE: relative to tile center
...
fn vs_main(input: VertexInput) -> VertexOutput {
    ...
    // RTE: vertex position is relative to tile center.
